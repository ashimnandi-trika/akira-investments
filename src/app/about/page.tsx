    ...
    <main className="min-h-screen bg-white text-black">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-light tracking-wide mb-4 sm:mb-6">Origin</h2>
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-light tracking-wide mb-4 sm:mb-6">The Ensō</h2>
              <p className="text-neutral-500 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
      ...
      <section className="py-16 sm:py-24 md:py-32 bg-neutral-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <p className="text-[#C8102E] text-xs sm:text-sm tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-3 sm:mb-4">Guiding Principles</p>
            <h2 className="text-2xl sm:text-3xl font-light tracking-wide">Three Truths</h2>
          </div>
            ...
            {principles.map((principle) => (
              <div key={principle.number} className="text-center">
                <div className="relative mb-6 sm:mb-8">
                  <EnsoCircle className="w-16 sm:w-20 h-16 sm:h-20 mx-auto text-neutral-200" />
                  <span className="absolute inset-0 flex items-center justify-center text-lg sm:text-xl font-light text-[#C8102E]">
                    {principle.number}
                  </span>
                </div>
                <h3 className="text-lg sm:text-xl font-light tracking-wide mb-3 sm:mb-4">{principle.title}</h3>
                <p className="text-xs sm:text-sm text-neutral-500 leading-relaxed">{principle.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
            <div>
              <p className="text-[#C8102E] text-xs sm:text-sm tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-3 sm:mb-4">The Mathematics</p>
              <h2 className="text-2xl sm:text-3xl font-light tracking-wide mb-4 sm:mb-6">
                One Formula
              </h2>
              <p className="text-neutral-500 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
            ...
            <div className="flex justify-center">
              <div className="p-6 sm:p-8 md:p-12 border border-neutral-200 bg-white text-center w-full max-w-sm">
                <p className="text-xs text-neutral-400 tracking-[0.15em] sm:tracking-[0.2em] uppercase mb-4 sm:mb-6">The Core Formula</p>
                <p className="text-3xl sm:text-4xl font-light tracking-wide mb-3 sm:mb-4">
                  G = E[R] - <span className="text-[#C8102E]">σ²/2</span>
                </p>
                <p className="text-xs sm:text-sm text-neutral-400">Expected growth minus variance drag</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 md:py-32 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <EnsoCircle className="w-12 sm:w-16 h-12 sm:h-16 mx-auto mb-6 sm:mb-8 text-white/20" />
          <h2 className="text-2xl sm:text-3xl font-light tracking-wide mb-4 sm:mb-6">Walk With Us</h2>
          <p className="text-neutral-400 mb-8 sm:mb-12 max-w-lg mx-auto text-sm sm:text-base">
            We welcome conversations with those who understand that mastery 
            is a path, not a destination.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 sm:gap-3 px-8 sm:px-10 py-4 sm:py-5 bg-white text-black hover:bg-[#C8102E] hover:text-white transition-colors duration-300 tracking-widest text-xs sm:text-sm"
          >
