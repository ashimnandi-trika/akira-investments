...
const navigation = [
  { name: "Philosophy", href: "/v1/about" },
  { name: "Portfolio", href: "/v1/portfolio" },
  { name: "Leadership", href: "/v1/leadership" },
  { name: "Contact", href: "/v1/contact" },
]
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm">
      <nav className="max-w-6xl mx-auto px-8 py-6 flex items-center justify-between">
        <Link href="/v1" className="text-2xl tracking-[0.3em] font-light">
          AKIRA
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <Link href="/v1/about" className="block text-sm text-neutral-500 hover:text-black transition-colors">Philosophy</Link>
              <Link href="/v1/portfolio" className="block text-sm text-neutral-500 hover:text-black transition-colors">Portfolio</Link>
              <Link href="/v1/leadership" className="block text-sm text-neutral-500 hover:text-black transition-colors">Leadership</Link>
            </div>
          </div>
          <div>
            <p className="text-xs tracking-[0.2em] text-neutral-400 uppercase mb-4">Contact</p>
            <div className="space-y-3">
              <Link href="/v1/contact" className="block text-sm text-neutral-500 hover:text-black transition-colors">Investor Relations</Link>
